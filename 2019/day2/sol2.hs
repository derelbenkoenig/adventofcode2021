...
solve :: Machine -> Int
solve = solveWith (12, 2)

solveWith args startingMachine = arr ! 0 where
    Machine arr _ = last $ machineStates (restoreState args startingMachine)
...
restoreState (noun, verb) (Machine arr s) = Machine (arr // [(1, noun), (2, verb)]) s
